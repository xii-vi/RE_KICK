...
export const Filter = ()=>{
    const {dispatch , state :{priceRange}} = useCart()
    return(
        <>
        <div>
                    ...
                    <div className="sm-filter-container">
                        ...
                        <div className="flex flex-direction-col">
                            ...
                            <label className="py-1" for="Unisex">
                                <input type="radio" value="Unisex" name="radio-button" onChange={() => dispatch({ type: "GENDER", payload: "UNISEX" })}/> Unisex
                            </label>
                            ...
                            <label className="py-1" for="Women">
                                <input type="radio" value="Women" name="radio-button" onChange={() => dispatch({ type: "GENDER", payload: "WOMEN" })}/> Women
                            </label>
                        </div>
                        ...
                        <div className="flex flex-direction-col">
                            <label className="py-1"><input type="radio" name="radio-button" onChange={() => dispatch({ type: "RATING", payload: 4 })}/>
                                4★ & above
                            </label>
                            <label className="py-1"><input type="radio" name="radio-button" onChange={() => dispatch({ type: "RATING", payload: 3 })}/>
                                3★ & above
                            </label>
                            <label className="py-1"><input type="radio" name="radio-button" onChange={() => dispatch({ type: "RATING", payload: 2 })}/>
                                2★ & above
                            </label>
                            <label className="py-1"><input type="radio" name="radio-button" onChange={() => dispatch({ type: "RATING", payload: 1 })}/>
                                1★ & above
                            </label>
                        </div>
                        ...
                        <div className=" text-center mt-4">
                            <p className="py-2 active-page-text">Reset Filters</p>
                        </div>
