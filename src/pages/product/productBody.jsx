...
export const ProductBody = ()=>{
    ...
    return(
        ...
        <input type="text" placeholder="Search for Sneaker" onChange={(e) => dispatch({ type: "FILTER_BY_SEARCH", payload: e.target.value })} />
        <button><i className="fa fa-search cursor-pointer"></i></button>
            </div>
            <div className="m-5">
                <select className="p-2" onChange={(e) => dispatch({ type: "SORT", payload: e.target.value })}>
